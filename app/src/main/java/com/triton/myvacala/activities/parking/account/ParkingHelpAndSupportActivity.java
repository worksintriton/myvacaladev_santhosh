...
public class ParkingHelpAndSupportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String TAG = "ParkingHelpAndSupportActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_and_support_parking);
        ...
        if (new ConnectionDetector(ParkingHelpAndSupportActivity.this).isNetworkAvailable(ParkingHelpAndSupportActivity.this)) {
            fAQResponseCall();
        }
    }
    ...
    public void callDirections(String tag) {
        Intent intent = new Intent(ParkingHelpAndSupportActivity.this, DashboardParkingActivity.class);
