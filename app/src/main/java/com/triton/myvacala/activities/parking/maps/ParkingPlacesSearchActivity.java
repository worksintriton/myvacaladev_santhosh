...
import com.triton.myvacala.adapter.ParkingPlacesResultsAdapter;
...
public class ParkingPlacesSearchActivity extends AppCompatActivity implements PlacesNameListener {

    String TAG = "ParkingPlacesSearchActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ParkingPlacesSearchActivity.this;
    ...
    private void setViewPlacesResulsts() {
        ...
        ParkingPlacesResultsAdapter parkingPlacesResultsAdapter = new ParkingPlacesResultsAdapter(mContext, predictionsBeanList, rv_placesresults, ParkingPlacesSearchActivity.this);
        ...
        service.getaddressResults(PlacesName, key).enqueue(new Callback<AddressResultsResponse>() {
            ...
            public void onResponse(@NotNull Call<AddressResultsResponse> call, @NotNull Response<AddressResultsResponse> response) {
                ...
                if (resultsBeanList.size() > 0 ) {
                    ...
                    Intent i = new Intent(ParkingPlacesSearchActivity.this, DashboardParkingActivity.class);
