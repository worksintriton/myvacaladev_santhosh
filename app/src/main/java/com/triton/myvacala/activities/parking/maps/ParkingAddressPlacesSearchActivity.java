...
import com.triton.myvacala.adapter.ParkingAddressPlacesResultsAdapter;
...
public class ParkingAddressPlacesSearchActivity extends AppCompatActivity implements PlacesNameListener {

    String TAG = "ParkingAddressPlacesSearchActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ParkingAddressPlacesSearchActivity.this;
    ...
    private void setViewPlacesResulsts() {
        ...
        ParkingAddressPlacesResultsAdapter parkingPlacesResultsAdapter = new ParkingAddressPlacesResultsAdapter(mContext, predictionsBeanList, rv_placesresults, ParkingAddressPlacesSearchActivity.this);
        rv_placesresults.setAdapter(parkingPlacesResultsAdapter);

        parkingPlacesResultsAdapter.setOnLoadMoreListener(() -> {
        ...
        service.getaddressResults(PlacesName, key).enqueue(new Callback<AddressResultsResponse>() {
            ...
            public void onResponse(@NotNull Call<AddressResultsResponse> call, @NotNull Response<AddressResultsResponse> response) {
                ...
                if (resultsBeanList.size() > 0 ) {
                    ...
                    Log.w(TAG,"addressResponseCall cityname-->"+selectedPlaceName);

                    Intent i = new Intent(ParkingAddressPlacesSearchActivity.this, ParkingAddAddressMapsActivity.class);
