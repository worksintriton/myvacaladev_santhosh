...
public class ParkingNotificationActivity extends AppCompatActivity {
    ...
    String TAG = "ParkingNotificationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_parking);
        ...
        session = new SessionManager(ParkingNotificationActivity.this);
        ...
        if (new ConnectionDetector(ParkingNotificationActivity.this).isNetworkAvailable(ParkingNotificationActivity.this)) {
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ParkingNotificationActivity.this, DashboardParkingActivity.class);
