...
public class EditMyAddressActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    String  flatno = "",nearbylandmark ="",locationnickname = "",locationtype ="";
     ...
     String id = "";
    private String pincode,redirect_to;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
           ...
           if(latlng != null && !latlng.equalsIgnoreCase("null")) {
            ...
            redirect_to=extras.getString("redirect");
            ...
            public void onResponse(@NotNull Call<LocationEditResponse> call, @NotNull Response<LocationEditResponse> response) {
                ...
                if (response.body() != null) {
                    ...
                    if(response.body().getCode() == 200){
                       ...
                       if(redirect_to.equals("from_choose")){
                           Intent i = new Intent(EditMyAddressActivity.this,ChooseYourAddressActivity.class);
                       ...
                       else if(redirect_to.equals("from_choose")){
                            Intent i = new Intent(EditMyAddressActivity.this,ChooseYourAddressActivity.class);
                            i.putExtra("fromactivity",TAG);
                            startActivity(i);
                            finish();
