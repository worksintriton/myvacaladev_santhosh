...
import com.triton.myvacala.adapter.CityListOldUserParkingAdapter;
...
public class ParkingSelectYourCityOldUserActivity extends AppCompatActivity {
    ...
    CityListOldUserParkingAdapter cityListAdapter;
    private SharedPreferences preferences;
    String TAG = "ParkingSelectYourCityOldUserActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parking_select_your_city_old_user);
        ...
        if (new ConnectionDetector(ParkingSelectYourCityOldUserActivity.this).isNetworkAvailable(ParkingSelectYourCityOldUserActivity.this)) {
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ParkingSelectYourCityOldUserActivity.this, DashboardParkingActivity.class);
    ...
    private void setView() {
        ...
        cityListAdapter = new CityListOldUserParkingAdapter(getApplicationContext(), getServiceListResponseList, rv_citylist);
