...
public class ParkingPickUpLocationActivity extends AppCompatActivity {
    ...
    String TAG = "ParkingPickUpLocationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_selectcity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ParkingPickUpLocationActivity.this,ParkingLocationsCityActivity.class));
            }
        });
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ParkingPickUpLocationActivity.this, DashboardParkingActivity.class);
