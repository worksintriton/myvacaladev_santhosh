...
public class ParkingEditPickUpLocationActivity extends AppCompatActivity {
    ...
    String TAG = "ParkingEditPickUpLocationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_up_location_parking);
        Log.w(TAG,"onCreate--->");
        ...
        btn_selectcity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ParkingEditPickUpLocationActivity.this,ParkingEditSelectYourCityActivity.class));
            }
        });
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ParkingEditPickUpLocationActivity.this, DashboardParkingActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ParkingEditPickUpLocationActivity.this,ParkingEditMapsActivity.class));
        finish();
    }
}