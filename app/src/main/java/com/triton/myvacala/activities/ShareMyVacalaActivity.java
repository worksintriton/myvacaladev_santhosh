...
public class ShareMyVacalaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String TAG = "ShareMyVacalaActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_share_my_vacala);
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ShareMyVacalaActivity.this,DashboardActivity.class);
