...
public class ParkingEditSelectYourCityActivity extends AppCompatActivity {
    ...
    String TAG = "ParkingEditSelectYourCityActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new ConnectionDetector(ParkingEditSelectYourCityActivity.this).isNetworkAvailable(ParkingEditSelectYourCityActivity.this)) {
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(ParkingEditSelectYourCityActivity.this, DashboardParkingActivity.class);
    ...
    private void setView() {
        ...
        ParkingEditCityListAdapter cityListAdapter = new ParkingEditCityListAdapter(getApplicationContext(), getServiceListResponseList, rv_citylist);
