...
public class Parking_Profile_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    String TAG = "Parking_Profile_Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.w(TAG,"onCreate--->");
        session = new SessionManager(Parking_Profile_Activity.this);
        session.checkLogin();
    ...
    private void alertDialogOTP() {
        ...
        try {
            ...
            dialog = new Dialog(Parking_Profile_Activity.this);
            ...
            txt_Resend.setOnClickListener(v -> {
                if (new ConnectionDetector(Parking_Profile_Activity.this).isNetworkAvailable(Parking_Profile_Activity.this)) {
                    verifyOtp();
                }
            });
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(Parking_Profile_Activity.this, DashboardParkingActivity.class);
