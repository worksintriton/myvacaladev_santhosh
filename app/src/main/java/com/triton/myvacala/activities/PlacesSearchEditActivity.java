...
import com.triton.myvacala.adapter.PlacesResultsEditAdapter;
...
public class PlacesSearchEditActivity extends AppCompatActivity implements PlacesNameListener {

    String TAG = "PlacesSearchEditActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PlacesSearchEditActivity.this;
    ...
    private void setViewPlacesResulsts() {
        ...
        PlacesResultsEditAdapter placesResultsEditAdapter = new PlacesResultsEditAdapter(mContext, predictionsBeanList, rv_placesresults, PlacesSearchEditActivity.this);
        rv_placesresults.setAdapter(placesResultsEditAdapter);

        placesResultsEditAdapter.setOnLoadMoreListener(() -> {
        ...
        service.getaddressResults(PlacesName, key).enqueue(new Callback<AddressResultsResponse>() {
            ...
            public void onResponse(@NotNull Call<AddressResultsResponse> call, @NotNull Response<AddressResultsResponse> response) {
                ...
                if (resultsBeanList.size() > 0 ) {
                    ...
                    Intent i = new Intent(PlacesSearchEditActivity.this, EditMapsActivity.class);
