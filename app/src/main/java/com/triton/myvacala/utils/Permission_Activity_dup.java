...
public class Permission_Activity_dup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionManager(Permission_Activity_dup.this);
        session.checkLogin();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Window window = Permission_Activity_dup.this.getWindow();
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            window.setStatusBarColor(Permission_Activity_dup.this.getResources().getColor(R.color.myvacalabutton));
        }
        if(!islogedin) {
            insertmappermission();
        }else{
    ...
    private void showMessageOKCancel(DialogInterface.OnClickListener okListener) {
        ...
        new AlertDialog.Builder(Permission_Activity_dup.this)
