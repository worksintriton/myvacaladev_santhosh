...
public class CityListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CityListAdapter(Context context, List<GetServiceListResponse.DataBean> getServiceListResponseList, RecyclerView inbox_list) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.ll_citylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, MapsActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                i.putExtra("fromactivity","SelectYourCityActivity");
