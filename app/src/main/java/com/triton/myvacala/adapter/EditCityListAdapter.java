...
import com.triton.myvacala.activities.MapsActivity;
...
public class EditCityListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "EditCityListAdapter";
    ...
    public EditCityListAdapter(Context context, List<GetServiceListResponse.DataBean> getServiceListResponseList, RecyclerView inbox_list) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.ll_citylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, EditMapsActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
