...
//        }
        ...
        if(currentItem.getCart_count()>0){
            ...
            holder.btn_add_remove.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.ic_baseline_remove_24,0);

        }else{
            holder.btn_add_remove.setText("ADD");
            holder.btn_add_remove.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.ic_baseline_add_24,0);
        }
