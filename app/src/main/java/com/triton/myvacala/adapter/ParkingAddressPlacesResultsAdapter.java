...
import com.triton.myvacala.activities.parking.maps.ParkingAddressPlacesSearchActivity;
...
public class ParkingAddressPlacesResultsAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "ParkingAddressPlacesResultsAdapter";
    ...
    public ParkingAddressPlacesResultsAdapter(Context context, List<PlacesResultsResponse.PredictionsBean> predictionsBeanList, RecyclerView inbox_list, ParkingAddressPlacesSearchActivity parkingPlacesSearchActivity) {
