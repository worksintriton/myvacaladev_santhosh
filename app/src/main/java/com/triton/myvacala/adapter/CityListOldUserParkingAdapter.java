...
public class CityListOldUserParkingAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "CityListOldUserParkingAdapter";
    ...
    public CityListOldUserParkingAdapter(Context context, List<GetServiceListResponse.DataBean> getServiceListResponseList, RecyclerView inbox_list) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.ll_citylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, ParkingAddAddressMapsActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
