...
public class ParkingLocationsListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "ParkingLocationsListAdapter";
    ...
    ParkingLocationGetListResponse.DataBean currentItem;
    ...
    public ParkingLocationsListAdapter(Context context, List<ParkingLocationGetListResponse.DataBean> getServiceListResponseList, RecyclerView inbox_list) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.ll_citylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, DashboardParkingActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                i.putExtra("cityname",getServiceListResponseList.get(position).getDisplay_Name());
                i.putExtra("fromactivity","ParkingPlacesSearchActivity");
                i.putExtra("tag","1");
                Bundle b = new Bundle();
