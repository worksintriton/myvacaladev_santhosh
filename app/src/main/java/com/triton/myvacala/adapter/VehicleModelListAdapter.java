...
public class VehicleModelListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "VehicleModelListAdapter";
    ...
    VehicleDetailsResponse.DataBean.VehicleModelBean currentItem;
    ...
    public VehicleModelListAdapter(Context context, List<VehicleDetailsResponse.DataBean.VehicleModelBean> vehicleModelBeanList, RecyclerView inbox_list, VehicleModeTypeListener vehicleModeTypeListener, String vehicle_Model_Name) {
