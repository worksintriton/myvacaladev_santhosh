...
import com.triton.myvacala.activities.PlacesSearchActivity;
import com.triton.myvacala.activities.PlacesSearchNewActivity;
...
public class PlacesResultsNewAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "PlacesResultsNewAdapter";
    ...
    public PlacesResultsNewAdapter(Context context, List<PlacesResultsResponse.PredictionsBean> predictionsBeanList, RecyclerView inbox_list, PlacesSearchNewActivity placesSearchNewActivity) {
        this.predictionsBeanList = predictionsBeanList;
        this.context = context;

       this.placesNameListener = (PlacesNameListener)placesSearchNewActivity;
