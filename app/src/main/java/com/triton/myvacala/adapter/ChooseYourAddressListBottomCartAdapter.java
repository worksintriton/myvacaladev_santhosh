...
public class ChooseYourAddressListBottomCartAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<LocationListResponse.DataBean> locationAvailableBeanArrayList;
  ...
  private LocationIdListener locationIdListener;
    ...
    public ChooseYourAddressListBottomCartAdapter(Context context, List<LocationListResponse.DataBean> locationAvailableBeanArrayList, RecyclerView inbox_list, String fromactivity, LocationIdListener locationIdListener) {
