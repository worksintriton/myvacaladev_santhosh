...
public class PlacesResultsEditAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "PlacesResultsEditAdapter";
    ...
    public PlacesResultsEditAdapter(Context context, List<PlacesResultsResponse.PredictionsBean> predictionsBeanList, RecyclerView inbox_list, PlacesSearchEditActivity placesSearchEditActivity) {
        this.predictionsBeanList = predictionsBeanList;
        this.context = context;

       this.placesNameListener = (PlacesNameListener)placesSearchEditActivity;
