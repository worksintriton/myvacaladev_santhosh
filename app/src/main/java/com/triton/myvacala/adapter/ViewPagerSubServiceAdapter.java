...
public class ViewPagerSubServiceAdapter extends PagerAdapter {
    private Context context;
    private LayoutInflater inflater;
    private View itemView;
    ArrayList<String> homeBannerResponseArrayList;
    private String TAG = "ViewPagerMainServiceAdapter";

    public ViewPagerSubServiceAdapter(Context context, ArrayList<String> homeBannerResponseArrayList){
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        try {
            String imageURL = homeBannerResponseArrayList.get(position);
